...
def play_chord(chord):
    ...
    st.session_state.current = chord
...
# 3. DOWNLOAD CHORD FILE
st.subheader(" Download Chord File")
...
st.subheader(" Current Beat")

st.success(
    f"Current Chord: {st.session_state.current}"
)
# 5. CHORD HISTORY
